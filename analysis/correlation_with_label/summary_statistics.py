...
class FeatureAnalysis:
    ...
    def write_results(self, file_path):
        ...
        with open(file_path, "w") as f:
            ...
            f.write(f"Mean when there is NO ATTACK: {mean_0:.3f} +- {std_0:.3f}\n")
            f.write(f"95% confidence interval: [{float(ci_0[0]):.3f}, {float(ci_0[1]):.3f}]\n")
            f.write(f"Mean when there is an ATTACK: {mean_1:.3f} +- {std_1:.3f}\n")
            f.write(f"95% confidence interval: [{float(ci_1[0]):.3f}, {float(ci_1[1]):.3f}]\n")
            f.write(f"\nMedian of {self.feature} when there is NO ATTACK: {median_0:.3f}\n")
            f.write(f"95% confidence interval: [{float(median_ci_0[0]):.3f}, {float(median_ci_0[1]):.3f}]\n")
            f.write(f"Median of {self.feature} when there is an ATTACK: {median_1:.3f}\n")
            f.write(f"95% confidence interval: [{float(median_ci_1[0]):.3f}, {float(median_ci_1[1]):.3f}]\n")
            f.write(f"\nMin value with NO ATTACK: {self.group_0.min():.3f}\n")
            f.write(f"Max value with NO ATTACK: {self.group_0.max():.3f}\n")
            f.write(f"\nMin value with ATTACK: {self.group_1.min():.3f}\n")
            f.write(f"Max value with ATTACK: {self.group_1.max():.3f}\n")
            f.write(f"\n25th percentile (Q1) when NO ATTACK: {q25_0:.3f}\n")
            f.write(f"75th percentile (Q3) when NO ATTACK: {q75_0:.3f}\n")
            f.write(f"25th percentile (Q1) when ATTACK: {q25_1:.3f}\n")
            f.write(f"75th percentile (Q3) when ATTACK: {q75_1:.3f}\n")
            f.write(f"\nCoefficient of Variation when NO ATTACK: {cv_0:.3f}\n")
            f.write(f"Coefficient of Variation when ATTACK: {cv_1:.3f}\n")
    ...
    def print_results(self):
        ...
        #all with at most 3 decimal places
        print(f"Average of {self.feature} when there is NO ATTACK: {mean_0:.3f} ± {std_0:.3f}")
        print(f"95% confidence interval: [{float(ci_0[0]):.3f}, {float(ci_0[1]):.3f}]")
        print(f"Average of {self.feature} when there is an ATTACK: {mean_1:.3f} ± {std_1:.3f}")
        print(f"95% confidence interval: [{float(ci_1[0]):.3f}, {float(ci_1[1]):.3f}]\n")
        print(f"Median of {self.feature} when there is NO ATTACK: {median_0:.3f}")
        print(f"95% confidence interval: [{float(median_ci_0[0]):.3f}, {float(median_ci_0[1]):.3f}]\n")
        print(f"Median of {self.feature} when there is an ATTACK: {median_1:.3f}")
        print(f"95% confidence interval: [{float(median_ci_1[0]):.3f}, {float(median_ci_1[1]):.3f}]\n")
        print(f"25th percentile (Q1) when NO ATTACK: {q25_0:.3f}")
        print(f"75th percentile (Q3) when NO ATTACK: {q75_0:.3f}")
        print(f"25th percentile (Q1) when ATTACK: {q25_1:.3f}")
        print(f"75th percentile (Q3) when ATTACK: {q75_1:.3f}")
        print(f"\nMin value with NO ATTACK: {self.group_0.min():.3f}\n")
        print(f"Max value with NO ATTACK: {self.group_0.max():.3f}\n")
        print(f"\nMin value with ATTACK: {self.group_1.min():.3f}\n")
        print(f"Max value with ATTACK: {self.group_1.max():.3f}\n")
        print(f"\nCoefficient of Variation when NO ATTACK: {cv_0:.3f}")
        print(f"Coefficient of Variation when ATTACK: {cv_1:.3f}\n")
